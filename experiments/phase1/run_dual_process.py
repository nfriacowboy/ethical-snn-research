"""Run dual-process experiments (Condition B).

This script runs 100 simulations with dual-process architecture.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run dual-process simulation')
    parser.add_argument('--config', type=str, default='experiments/phase1/config_phase1.yaml',
                       help='Path to config file')
    parser.add_argument('--run_id', type=int, default=0,
                       help='Run ID for this simulation')
    ...
    # Force dual-process architecture
    config['architecture'] = 'dual'
    
    print("=" * 60)
    print("PHASE 1 - CONDITION B: Dual-Process SNN")
    print("=" * 60)
