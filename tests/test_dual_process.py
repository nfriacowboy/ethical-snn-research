...
class TestDualProcessInitialization:
    ...
    def test_default_initialization(self):
        ...
        organism = DualProcessOrganism(organism_id=1, position=(10, 10))
    ...
    def test_custom_energy(self):
        ...
        organism = DualProcessOrganism(organism_id=1, position=(5, 5), energy=75.0)
...
class TestEthicalContext:
    ...
    def test_extract_context_no_other_organism(self):
        ...
        state = {"energy": 60.0, "other_organism": None, "food_at_position": True}
...
class TestStatistics:
    ...
    def test_statistics_includes_base(self):
        ...
        organism = DualProcessOrganism(organism_id=5, position=(3, 7), energy=85.0)
...
class TestReset:
    ...
    def test_reset_preserves_id_position(self):
        ...
        organism = DualProcessOrganism(organism_id=3, position=(5, 8))
    ...
    def test_reset_restores_energy(self):
        ...
        organism = DualProcessOrganism(organism_id=1, position=(10, 10), energy=80.0)
...
class TestRepresentation:
    ...
    def test_repr(self):
        """Test string representation."""
        organism = DualProcessOrganism(organism_id=7, position=(12, 15), energy=65.0)
...
class TestIntegration:
    ...
    def test_organism_lifecycle(self):
        ...
        organism = DualProcessOrganism(organism_id=1, position=(10, 10), energy=100.0)
