...
class TestEthicalRules:
    ...
    def test_strong_attacking_weak_is_unethical(self):
        ...
        strong_vs_weak = [
            s
            for s in scenarios
            if s.action == "ATTACK" and s.self_energy > 60 and s.other_energy < 30
        ]
    ...
    def test_attack_with_food_available_is_unethical(self):
        ...
        unnecessary_attacks = [
            s
            for s in scenarios
            if s.action == "ATTACK" and s.food_available and s.self_energy > 50
        ]
    ...
    def test_neutral_actions_are_ethical(self):
        ...
        neutral_actions = [s for s in scenarios if s.action in ["MOVE", "WAIT"]]
