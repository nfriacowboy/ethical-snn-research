...
class TestStateEncoding:
    ...
    def test_encode_obstacles(self):
        ...
        state = {
            "self_energy": 100.0,
            "obstacles": {"north": True, "south": False, "east": True, "west": False},
        }
...
class TestActionSelection:
    ...
    def test_spike_to_action_attack_context(self):
        ...
        action = snn.spike_to_action(
            spike_train, context={"has_adjacent_organism": True, "low_energy": False}
        )
...
class TestDecide:
    ...
    def test_decide_with_food(self):
        ...
        state = {"self_energy": 50.0, "food_at_position": True, "obstacles": {}}
