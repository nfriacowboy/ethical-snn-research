...
from src.environment.collision_handler import (AttackResult, check_collision,
...
class TestAdjacentDetection:
    ...
    def test_toroidal_wrapping(self):
        ...
        adjacent = detect_adjacent_organisms(
            (0, 0), positions, grid_size=20, toroidal=True
        )
    ...
    def test_non_toroidal_edges(self):
        ...
        adjacent = detect_adjacent_organisms(
            (0, 0), positions, grid_size=20, toroidal=False
        )
