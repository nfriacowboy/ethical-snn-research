...
class TestOrganismInitialization:
    ...
    def test_basic_init(self):
        ...
        org = TestOrganism(organism_id=0, position=(10, 10), initial_energy=100.0)
    ...
    def test_custom_energy(self):
        ...
        org = TestOrganism(
            organism_id=5, position=(5, 5), initial_energy=80.0, max_energy=150.0
        )
...
class TestEnergyManagement:
    ...
    def test_energy_clamped_to_max(self):
        ...
        org = TestOrganism(
            organism_id=0, position=(10, 10), initial_energy=90.0, max_energy=100.0
        )
    ...
    def test_death_on_negative_energy(self):
        ...
        org = TestOrganism(organism_id=0, position=(10, 10), initial_energy=30.0)
    ...
    def test_stays_dead(self):
        ...
        org = TestOrganism(organism_id=0, position=(10, 10), initial_energy=10.0)
